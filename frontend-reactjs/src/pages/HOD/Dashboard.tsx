        ...
        <div className="space-y-8">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="mobile-title-lg text-foreground tracking-tight leading-none mb-1">HOD Dashboard</h1>
                        <p className="text-muted-foreground font-bold text-sm tracking-tight">{user.department} Department Oversight</p>
                    </div>
                </div>
                    ...
                    filteredRequests.map((req) => (
                        <Card key={req.id} className="card-premium border-none shadow-sm overflow-hidden group">
                            <div className="p-6 sm:p-8">
                                    ...
                                    <div className="flex items-center gap-6">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex flex-wrap items-center gap-x-4 gap-y-1">
                                                ...
                                                <span className="text-sm font-bold text-muted-foreground">{req.yearSection}</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="mb-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 bg-muted/50 p-6 rounded-[1.5rem] border-2 border-border">
                                    ...
                                    <div className="space-y-1">
                                        <p className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em]">Assigned Incharge</p>
                                        <div className="flex items-center gap-2">
                                            <p className="text-sm text-foreground font-bold capitalize">{req.inchargeName}</p>
                                ...
                                {req.hodStatus === 'Pending' ? (
                                    <div className="mt-8 flex flex-col lg:flex-row lg:items-end gap-4 border-t border-slate-100 dark:border-slate-800 pt-6">
                                        <div className="flex-1 space-y-2">
                                            <Label className="font-bold text-muted-foreground ml-1">Final Approval Remarks</Label>
                                            <Input 
                                        ...
                                        <div className="flex flex-col sm:flex-row items-center justify-end gap-3 w-full lg:w-auto shrink-0 mt-4 lg:mt-0">
                                            ...
                                            <Button 
                                                className="btn-3d-purple rounded-xl h-10 w-full sm:h-11 sm:w-auto px-8 font-bold"
