        ...
        <SafeAreaView className="flex-1 bg-background px-4 pt-4">
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <View className="items-center mb-8">
                    <Text className="text-2xl font-bold text-red-500 mb-4">PROFILE</Text>
                ...
                <Card className="mb-8 border-0 shadow-none">
                    <CardContent className="gap-6">
                        <View className="flex-row items-center">
                            ...
                            <Input
                                className="flex-1 border-b border-border bg-transparent px-0 h-10"
                                value={phone}
                        ...
                        <Button className="mt-6 bg-blue-400 w-full rounded-xl" onPress={handleUpdate} disabled={updating}>
                            <Text className="text-white font-bold tracking-widest">{updating ? 'UPDATING...' : 'UPDATE'}</Text>
                        </Button>
